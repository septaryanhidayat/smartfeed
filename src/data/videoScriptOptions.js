...
export const VIDEOSCRIPT_DEMO_PRESETS = [
  {
    id: 'demo-bi-sultra-liputan',
    label: 'Liputan Video: Sinergi BI & UMKM Sultra Naik Kelas',
    badge: 'LIPUTAN VO / 60S',
    icon: 'Clapperboard',
    preset: {
      title: 'Sinergi Bank Indonesia Sulawesi Tenggara: UMKM Naik Kelas & Transaksi Digital Melesat',
      scriptType: 'news_reportage',
      duration: '60s',
      platform: 'TV / Media Broadcasting',
      tone: 'Edukatif, Bernas & Mudah Dipahami',
      visualStyle: 'Documentary Realism (On-Location B-Roll)',
      speaker: 'Voice Over (VO) Reporter Jurnalis Ekonomi + Soundbite Perwakilan BI & Pelaku UMKM',
      coreMessage: 'Sinergi nyata Bank Indonesia Sultra lewat Expo UMKM dan pembiayaan kredit yang tumbuh 12,7% membuahkan akselerasi ekonomi digital di Kendari.',
      keyPoints: '1. Pembukaan festival UMKM dan pameran produk tenun/kuliner lokal. 2. Kemudahan transaksi non-tunai scan QRIS di setiap stan. 3. Pertumbuhan kredit UMKM 12,7% dan komitmen keberlanjutan BI.',
      callToAction: 'Dukung terus kebangkitan ekonomi daerah dengan berbelanja produk lokal dan Bangga Pakai Rupiah!',
      additionalNotes: 'Format naskah ke dalam dua kolom: Arahan Visual Kamera (B-Roll) dan Naskah Audio/VO.',
    },
  },
  {
    id: 'demo-tenun-sultra-tiktok',
    label: 'Kreator TikTok: Jelajah Tenun Khas Sultra & Bayar Pakai QRIS',
    badge: 'UGC / REELS 45S',
    icon: 'Sparkles',
    preset: {
      title: 'Review Jujur Tenun Tradisional Khas Sulawesi Tenggara + Bayar Sat-Set Pakai QRIS',
      scriptType: 'short_video',
      duration: '60s',
      platform: 'TikTok & IG Reels',
      tone: 'Enerjik, Cepat & Menghibur (Gen Z / Medsos)',
      visualStyle: 'UGC Raw Smartphone Style (Authentic & Relatable)',
      speaker: 'Content Creator Lifestyle / Travel muda',
      coreMessage: 'Kain tenun khas Sultra berkualitas tinggi dengan motif khas yang anggun, belanja langsung ke pengrajin lokal jadi super praktis tanpa uang tunai berkat QRIS.',
      keyPoints: '1. Hook 3 detik menyentuh tekstur halus kain tenun lokal. 2. Cerita singkat proses tenun handmade bernilai tinggi. 3. Scene bayar langsung scan QRIS tanpa ribet kembalian.',
      callToAction: 'Save video ini buat rekomendasi oleh-oleh khas Sultra dan follow buat jelajah budaya lokal berikutnya!',
      additionalNotes: 'Visual dinamis, close-up motif tenun, sound efek "beep" saat scan QRIS berhasil.',
    },
  },
  {
    id: 'demo-short-ai',
