...
export default function Sidebar({
  ...
  const renderNavContent = (isDrawer = false) => (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="px-3 py-3.5 border-b border-border flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="w-8 h-8 rounded-lg shadow-sm flex items-center justify-center shrink-0 bg-accent text-white font-black text-sm">
            {CONFIG.logoUrl ? (
              <img
                src={CONFIG.logoUrl}
        ...
        {isDrawer ? (
          ...
          <button
            ...
            title={isExpanded ? 'Sembunyikan Menu' : 'Tampilkan Nama Menu'}
          >
